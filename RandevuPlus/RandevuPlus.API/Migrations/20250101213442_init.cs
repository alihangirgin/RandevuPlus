        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRemovedFromSender = table.Column<bool>(type: "boolean", nullable: false),
                    IsRemovedFromReceiver = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    SlotStartIndex = table.Column<int>(type: "integer", nullable: false),
                    SlotEndIndex = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointments_Purchases_PurchaseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_PurchaseId",
                table: "Appointments",
                column: "PurchaseId");
